        ...
        implements ExtendedPlugInFilter, DialogListener
{
                          ...
                          final PlugInFilterRunner pfr)
    {
        ...
        dialog.addSlider(SENSITIVITY_PARAMETER, (double) SENSITIVITY_MIN, (double) SENSITIVITY_MAX, (double) sensitivity);
        dialog.addSlider(BACKGROUND_PARAMETER, (double) BACKGROUND_MIN, (double) BACKGROUND_MAX, (double) background);
        dialog.addSlider(SUTURE_PARAMETER, (double) SUTURE_MIN, (double) SUTURE_MAX, (double) suturecut);
        dialog.addMessage("HelloWorld");
                                     ...
                                     final AWTEvent e)
    {
        ...
        //suturecut = (int) gd.getNextNumber();
        ...
        return angleStep >= ANGLE_STEP_MIN && angleStep <= ANGLE_STEP_MAX
              ...
              // && suturecut >= SUTURE_MIN && suturecut <= SUTURE_MAX
